package com.nationwide.nationwide_server.core.errors.exception;
...
public class MyExceptionHandler {
    ...
    public ResponseEntity<ApiUtil.ApiResult<?>> ex400(Exception400 e) {
        return new ResponseEntity<>(ApiUtil.fail(e.getMessage(), HttpStatus.BAD_REQUEST, e.getMessage()), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler(Exception401.class)
    public ResponseEntity<ApiUtil.ApiResult<?>> ex401(Exception401 e) {
        return new ResponseEntity<>(ApiUtil.fail(e.getMessage(), HttpStatus.UNAUTHORIZED, e.getMessage()), HttpStatus.UNAUTHORIZED);
    }

    @ExceptionHandler(Exception403.class)
    public ResponseEntity<ApiUtil.ApiResult<?>> ex403(Exception403 e) {
        return new ResponseEntity<>(ApiUtil.fail(e.getMessage(), HttpStatus.FORBIDDEN, e.getMessage()), HttpStatus.FORBIDDEN);
    }

    @ExceptionHandler(Exception404.class)
    public ResponseEntity<ApiUtil.ApiResult<?>> ex404(Exception404 e) {
        return new ResponseEntity<>(ApiUtil.fail(e.getMessage(), HttpStatus.NOT_FOUND, e.getMessage()), HttpStatus.NOT_FOUND);
    }
    ...
    public ResponseEntity<ApiUtil.ApiResult<?>> ex500(Exception500 e) {
        ...
        log.error("======================================================");
        return new ResponseEntity<>(ApiUtil.fail(e.getMessage(), HttpStatus.INTERNAL_SERVER_ERROR, e.getMessage()), HttpStatus.INTERNAL_SERVER_ERROR);
    }
